...
public class AccountCategoryController {
    ...
    String nameagain = "";
    @Operation(summary = "Getting all the Account_category only")
    @GetMapping("/")
    ...
    @GetMapping("/find/allCategories")
    public ResponseEntity<List<Mdl_categoryDTo>> getCategories() {
        return new ResponseEntity<>(account_categoryRepository.findCategoryNoAccounts(), HttpStatus.OK);
    }
//    @Operation(summary="Getting all the Account_category only")
//    @GetMapping("/")
...
//    }
    ...
    @Operation(summary = "Total categries")
    @GetMapping("/count")
    public long countAll() {
        return account_categoryRepository.count();
    }

    @Operation(summary = "Creating a user category")
    @PostMapping("/")
