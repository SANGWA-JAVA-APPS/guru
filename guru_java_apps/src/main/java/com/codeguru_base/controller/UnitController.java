...
public class UnitController {
    ...
    @Operation(summary = "Get a single Unit by strcture id")
    ...
    @Operation(summary = "Update the unit bu its name")
    ...
    @Operation(summary = "Creating a unit")
    ...
    @Operation(summary = "Updating  a single Unit")
    @PutMapping("/{id}")
    ...
    @Operation(summary = "Deleting a single Unit")
    @DeleteMapping("/{id}")
