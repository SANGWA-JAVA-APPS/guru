...
public class TupleController {
    ...
    @Operation(summary = "Retrieve all Tuples")
    @GetMapping()
    ...
    @Operation(summary = "Retreving a single tuple")
    ...
    @Operation(summary = "Create tuple")
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Updating  a single Mdl_tuple")
