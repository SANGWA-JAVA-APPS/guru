...
public class LayoutController {
    ...
    @Operation(summary = "Retrieve all layouts")
    @GetMapping()
    ...
    @Operation(summary = "Retrieve duplciated tuple names by layout and structure")
    ...
    @Operation(summary = "Retrieve parents of a unit")
    ...
    @PutMapping("/{id}")
    @Operation(summary = "Updating  a single layout")
    ...
    @Operation(summary = "Deleting  a single layout")
